...
days <- read_csv("program/program.csv") |> 
  mutate(
...
target_logo <- image_read("img/logos/target3d.png") |> 
  image_fill('none') |> 
  as.raster() 

isds_logo <- image_read("img/logos/isds.png") |> 
  image_fill('none') |> 
  as.raster() 

bcs_logo <- image_read("img/logos/british-cartographic-society.png") |> 
  image_fill('none') |> 
  as.raster() 
...
conf <- glue::glue("<span style='font-size:120.0pt; font-family:\"jost\"'>GISRUK 2024 | University of Leeds</span>")
